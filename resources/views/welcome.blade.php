...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        .hero-overlay {
            background: linear-gradient(to bottom, rgba(0, 0, 0, 0.72) 0%, rgba(0, 0, 0, 0.38) 45%, rgba(0, 0, 0, 0.52) 100%);
        }

        .topbar { background: #15803d; }
        .nav-glass { background: rgba(0, 0, 0, 0.18); backdrop-filter: blur(5px); }
        ...
        .floating-card { box-shadow: 0 15px 40px rgba(0, 0, 0, .16); }
...
<body class="bg-slate-50 text-slate-800">
    ...
    <section class="relative min-h-[760px] md:min-h-screen hero-bg">
        ...
        <nav class="relative z-20 nav-glass border-b border-white/10">
            <div class="max-w-7xl mx-auto px-5 md:px-10">
                <div class="h-24 flex items-center justify-between">
                    ...
                    <a href="{{ route('login') }}" class="hidden sm:inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white text-green-700 text-sm font-bold hover:bg-green-50 transition">
                        Masuk
        ...
        <!-- HERO CONTENT -->
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center pt-28 md:pt-32 pb-20 md:pb-48">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm mb-7">
                ...
                <span class="text-white text-xs md:text-sm font-semibold tracking-wide">BANK MINI TERPADU SMKN 11 BANDUNG</span>
            </div>

            <h2 class="text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tight leading-none">SmartPocket</h2>
            <p class="mt-5 text-xl md:text-2xl text-white/95 font-medium">Solusi Digital BMT SMKN 11 Bandung</p>
            <p class="mt-6 max-w-3xl mx-auto text-base md:text-lg text-white/80 leading-relaxed">
                Kelola tabungan, transaksi, dan layanan keuangan BMT dengan lebih mudah, cepat, transparan, dan terintegrasi dalam satu platform digital.
            </p>

            <div class="mt-9 flex flex-col sm:flex-row justify-center items-center gap-4">
                <a href="{{ route('login') }}" class="btn-primary px-8 py-4 rounded-full text-white font-bold text-base flex items-center gap-2">
                    Mulai Sekarang
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                </a>
                <a href="#fitur" class="btn-light px-8 py-4 rounded-full font-bold text-base">Lihat Layanan</a>
            </div>
        </div>

        <!-- FLOATING CARD (DESKTOP ONLY - Absolute) -->
        <div class="hidden md:block absolute z-20 left-1/2 -translate-x-1/2 bottom-[-72px] w-[92%] max-w-6xl">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-5">
                    <div class="flex items-center gap-4 lg:border-r border-slate-200">
                        <div class="w-12 h-12 rounded-2xl bg-green-50 flex items-center justify-center shrink-0">
                            <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V6m0 12v-2m9-4a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-4 lg:border-r border-slate-200">
                        <div class="w-12 h-12 rounded-2xl bg-green-50 flex items-center justify-center shrink-0">
                            <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-4 lg:border-r border-slate-200">
                        <div class="w-12 h-12 rounded-2xl bg-yellow-50 flex items-center justify-center shrink-0">
                            <svg class="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-2xl bg-purple-50 flex items-center justify-center shrink-0">
                            <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                        </div>
                        <div>
    ...
    <!-- TENTANG -->
    <section id="tentang" class="pt-24 md:pt-40 pb-20 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <p class="text-green-600 font-bold text-sm uppercase tracking-wider mb-3">Tentang SmartPocket</p>
                    <h2 class="text-4xl md:text-5xl font-black text-slate-900 leading-tight">
                        BMT sekolah yang lebih <span class="text-green-600">modern dan terintegrasi.</span>
                    </h2>
                    <p class="mt-6 text-slate-600 leading-relaxed text-lg">
                        SmartPocket merupakan platform digital untuk mendukung pengelolaan BMT SMKN 11 Bandung agar proses tabungan, transaksi, dan layanan keuangan dapat dilakukan secara lebih praktis dan terorganisir.
                    </p>
                </div>
    ...
    <section id="layanan" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-14">
                <p class="text-green-600 font-bold text-sm uppercase tracking-wider mb-3">Layanan SmartPocket</p>
                <h2 class="text-4xl md:text-5xl font-black text-slate-900">Semua kebutuhan BMT dalam satu platform</h2>
                <p class="mt-5 text-slate-600">Dirancang untuk membantu nasabah, operator, dan admin mengelola aktivitas BMT dengan lebih praktis.</p>
            </div>
    ...
    <section class="py-24 bg-green-700">
        <div class="max-w-5xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-black text-white">Kelola BMT dengan lebih mudah bersama SmartPocket</h2>
            <p class="mt-5 text-white/80 text-lg max-w-2xl mx-auto">Satu platform untuk membantu menciptakan pengelolaan BMT SMKN 11 Bandung yang lebih praktis, tertata, dan modern.</p>
            <a href="{{ route('login') }}" class="inline-flex mt-8 px-8 py-4 rounded-full bg-white text-green-700 font-bold hover:bg-green-50 transition">Daftar Sekarang</a>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-3 gap-10">
                <div>
                    ...
                    <p class="mt-5 text-sm text-slate-400 leading-relaxed max-w-sm">Platform digital untuk mendukung pengelolaan layanan dan transaksi BMT SMKN 11 Bandung.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-400 leading-relaxed">SmartPocket — Bank Mini Terpadu untuk mendukung layanan keuangan di lingkungan SMKN 11 Bandung.</p>
                </div>
            </div>
            <div class="border-t border-white/10 mt-10 pt-6 text-center text-sm text-slate-500">© 2026 SmartPocket - BMT SMKN 11 Bandung</div>
        </div>
    </footer>
