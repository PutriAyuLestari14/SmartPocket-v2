...
<body class="bg-slate-50 text-slate-800 antialiased">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 ml-64 p-6">
            <!-- Header -->
            <div class="mb-4">
                <h1 class="text-xl font-bold text-slate-900">Input Setoran Dana</h1>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                            ...
                            <div class="mb-3">
                                <label class="block text-[10px] font-semibold text-slate-500 uppercase mb-1">Jumlah Setoran <span class="text-red-500">*</span></label>
                                <div class="relative">
                                    ...
                                    <input type="number" name="jumlah" id="nominalSetoran" value="{{ old('jumlah') }}" min="1000" step="1000"
                                        class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 text-right" required>
                                </div>
                                @error('jumlah') <p class="text-xs text-red-600 mt-1">{{ $message }}</p> @enderror
                                
                                <!-- Quick Amount Buttons -->
                                <div class="grid grid-cols-4 gap-2 mt-2">
                                    <button type="button" onclick="setNominal(50000)" class="py-1.5 border border-gray-200 rounded text-xs font-semibold text-slate-600 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 transition-colors">50.000</button>
                                    <button type="button" onclick="setNominal(100000)" class="py-1.5 border border-gray-200 rounded text-xs font-semibold text-slate-600 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 transition-colors">100.000</button>
                                    <button type="button" onclick="setNominal(200000)" class="py-1.5 border border-gray-200 rounded text-xs font-semibold text-slate-600 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 transition-colors">200.000</button>
                                    <button type="button" onclick="setNominal(500000)" class="py-1.5 border border-gray-200 rounded text-xs font-semibold text-slate-600 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 transition-colors">500.000</button>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <textarea name="keterangan" rows="2" placeholder="Contoh: Setoran tunai dari tabungan mingguan" 
                                    class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 resize-none" required>{{ old('keterangan') }}</textarea>
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4 sticky top-4">
                            ...
                            <div class="space-y-2 mb-4 text-sm">
                                <div class="flex justify-between items-center pb-2 border-b border-gray-100">
                                    ...
                                    <span class="text-xs font-bold text-slate-900">Setoran</span>
                                </div>
                                <div class="flex justify-between items-center pb-2 border-b border-gray-100">
                                ...
                                <div class="flex justify-between items-center pb-2 border-b border-gray-100">
                                    <span class="text-xs text-slate-600">Nominal Setor</span>
                                ...
                                <div class="flex justify-between items-center pt-1">
                                    <span class="text-xs text-slate-600">Estimasi Saldo Baru</span>
                                    <span class="text-sm font-bold text-emerald-600" id="summaryTotal">Rp 0</span>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 text-sm shadow-sm mb-2">
                                <i class="fas fa-print text-xs"></i> Proses Setoran
                            </button>
