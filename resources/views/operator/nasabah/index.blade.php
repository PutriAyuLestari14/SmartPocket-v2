        ...
        <main class="flex-1 ml-64 p-4 lg:p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mb-6">
                <div class="bg-white rounded-xl p-4 lg:p-5 border border-gray-200 shadow-sm">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl lg:text-2xl font-bold text-slate-900">{{ $totalNasabah ?? 1245 }}</p>
                            <p class="text-[10px] text-emerald-600 mt-1"><i class="fas fa-arrow-up"></i> +12% bulan ini</p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-4 lg:p-5 border border-gray-200 shadow-sm">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl lg:text-2xl font-bold text-slate-900">{{ $nasabahBaru ?? 48 }}</p>
                            <p class="text-[10px] text-emerald-600 mt-1"><i class="fas fa-arrow-up"></i> +5 dari bulan lalu</p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-4 lg:p-5 border border-gray-200 shadow-sm">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] font-semibold text-slate-500 uppercase mb-1">Rata-Rata Saldo</p>
                            <p class="text-xl lg:text-2xl font-bold text-slate-900">Rp 450.000</p>
                ...
                <div class="p-4 border-b border-gray-100">
                    <div class="flex flex-col sm:flex-row gap-3">
                        <div class="flex-1 relative">
                            ...
                            <input type="text" placeholder="Cari NIS, Nama..." class="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500">
                        </div>
                        ...
                        <button class="px-4 py-2.5 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors flex items-center justify-center">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 py-3 text-left text-[10px] font-semibold text-slate-500 uppercase">NIS</th>
                                <th class="px-4 py-3 text-left text-[10px] font-semibold text-slate-500 uppercase">Nama Nasabah</th>
                                <th class="px-4 py-3 text-left text-[10px] font-semibold text-slate-500 uppercase">Kelas/Jurusan</th>
                                <th class="px-4 py-3 text-left text-[10px] font-semibold text-slate-500 uppercase">Saldo Terakhir</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-xs text-slate-600">XI RPL 1</td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-center gap-2">
                                        <form action="{{ route('operator.nasabah.destroy', $n->id_nasabah) }}" 
                                            ...
                                            @method('DELETE')
                                            <button type="submit" 
                                                    class="w-7 h-7 bg-red-50 hover:bg-red-100 rounded-lg flex items-center justify-center text-red-600 transition-colors" 
                                                    title="Hapus">
                            ...
                            <tr>
                                <td colspan="6" class="px-4 py-10 text-center text-slate-500">
                                    ...
                                    <p class="text-sm">Belum ada data nasabah</p>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
